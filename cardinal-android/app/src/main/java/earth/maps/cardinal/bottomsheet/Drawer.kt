...
import androidx.compose.ui.unit.dp
import earth.maps.cardinal.bottomsheet.BottomDrawerState.Companion.Saver
import earth.maps.cardinal.bottomsheet.DrawerState.Companion.Saver
...
fun ModalDrawer(
    ...
    BoxWithConstraints(modifier.fillMaxSize()) {
        ...
        Box(
            ...
            val navigationMenu =
                getString(
                    Strings.Companion.NavigationMenu
                )
            Surface(
